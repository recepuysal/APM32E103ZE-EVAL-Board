...
/** @defgroup RCM_Driver RCM Driver
  * @brief RCM driver modules
  @{
*/

/** @defgroup RCM_Functions Fuctions
  @{
*/
 ...
 *
 * @param     ADCDiv : Specifies the SDRAM clock prescaler from the DMC clock.
 *                     This parameter can be one of the following values:
 *                     @arg RCM_DMC_DIV_1: SDRAMCLK = DMCCLK2 / 2
 *                     @arg RCM_DMC_DIV_2: SDRAMCLK = DMCCLK2 / 4
 *                     @arg RCM_DMC_DIV_4: SDRAMCLK = DMCCLK2 / 6
 *
 * @retval    None
 */
void RCM_ConfigSDRAMCLK(RCM_DMC_DIV_T SDRAMDiv)
{
